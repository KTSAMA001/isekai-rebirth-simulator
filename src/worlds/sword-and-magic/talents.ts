...
export const talents: WorldTalentDef[] = [
  // ==================== 普通天赋（14 个） ====================
  {
    id: 'peasant_birth',
    name: '农家子弟',
    description: '出身平凡，但吃苦耐劳',
    rarity: 'common',
    icon: '🌾',
    effects: [
  ...
  },
  {
    id: 'cursed_mark',
    name: '诅咒之印',
    description: '额头有一道神秘印记，魔力强大但不受控制',
    rarity: 'common',
    icon: '🌑',
    effects: [
  ...
  },
  {
    id: 'twin_souls',
    name: '双生魂',
    description: '灵魂裂成两半，感知极强但寿命短',
    rarity: 'common',
    icon: '👥',
    effects: [
      { type: 'modify_attribute', target: 'spr', value: 2, description: '灵魂 +2' },
      { type: 'modify_attribute', target: 'mag', value: 1, description: '魔力 +1' },
      { type: 'trigger_on_age', target: 'hp', value: -20, age: 60, description: '寿命损耗' },
    ],
    draftWeight: 100,
  },
  {
    id: 'blessed_by_goddess',
    name: '女神祝福',
    description: '受过女神殿的祝福仪式',
    rarity: 'common',
    icon: '🌟',
    effects: [
      { type: 'modify_attribute', target: 'chr', value: 1, description: '魅力 +1' },
  ...
  {
    id: 'village_hero_seed',
    name: '英雄之种',
    description: '你总觉得自己的命运不平凡',
    rarity: 'common',
    icon: '⭐',
    effects: [
      { type: 'modify_attribute', target: 'chr', value: 1, description: '魅力 +1' },
  ...
  // ==================== 稀有天赋（5 个） ====================
  {
    ...
    mutuallyExclusive: ['demon_heritage'],
    draftWeight: 10,
  },
  {
    id: 'royal_lineage',
    name: '王室血统',
    description: '帝国正统皇室的血脉后裔',
    rarity: 'rare',
    icon: '👑',
    effects: [
  ...
  },
  {
    id: 'demon_heritage',
    name: '魔族之裔',
    description: '隐藏着魔族的血脉，力量强大但会被追杀',
    rarity: 'rare',
    icon: '😈',
    effects: [
    ...
    mutuallyExclusive: ['dragon_blood'],
    draftWeight: 10,
  },
  {
    id: 'hero_summon',
    name: '勇者召唤',
    description: '被圣剑选中，肩负拯救世界的使命',
    rarity: 'rare',
    icon: '🗡️',
    effects: [
      { type: 'modify_attribute', target: 'str', value: 2, description: '体魄 +2' },
    ...
    replaceTalent: 'blessed_by_goddess',
    draftWeight: 10,
  },
  ...
  // ==================== 传说天赋（1 个） ====================
  {
    id: 'worldbreaker',
    name: '世界破坏者',
    description: '你不是来拯救世界的，你是来重启的',
    rarity: 'legendary',
    icon: '☄️',
    effects: [
      { type: 'modify_attribute', target: 'str', value: 3, description: '体魄 +3' },
      { type: 'modify_attribute', target: 'mag', value: 5, description: '魔力 +5' },
      { type: 'modify_attribute', target: 'spr', value: 3, description: '灵魂 +3' },
      { type: 'modify_attribute', target: 'luk', value: 3, description: '运势 +3' },
    ],
    conditions: 'luk >= 3',
    inheritable: true,
    flavorText: '世界不过是一场游戏，而你，是那个按下重启键的人。',
    draftWeight: 1,
  },
]
